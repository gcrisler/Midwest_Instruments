...
public class MyConfigMeterRecyclerViewAdapter extends RecyclerView.Adapter<MyConfigMeterRecyclerViewAdapter.ViewHolder> {
	...
	private final ConfigMeterFragment.OnListFragmentInteractionListener mListener;

	public MyConfigMeterRecyclerViewAdapter(List<DummyItem> items, ConfigMeterFragment.OnListFragmentInteractionListener listener) {
		mValues = items;
		mListener = listener;
	}
