...
public class BluetoothLeService extends Service {
	 ...
	 * asynchronously through the {@code BluetoothGattCallback#onCharacteristicRead(android.bluetooth.BluetoothGatt, android
	 * .bluetooth.BluetoothGattCharacteristic, int)}
	 * callback.
	 *
